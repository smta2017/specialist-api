...
class SliderCrudController extends CrudController
{
    ...
    {
        CRUD::column('name');
        CRUD::column('slider_type');
        CRUD::column('slides_per_page');
        CRUD::column('auto_play');
        CRUD::column('slider_width');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('name');
        CRUD::field('slider_type');
        CRUD::field('slides_per_page');
        CRUD::field('auto_play');
        CRUD::field('slider_width');
        CRUD::field('slider_height');
