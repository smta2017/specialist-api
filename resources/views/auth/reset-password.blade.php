    ...
    <div class="login-container">
        <section class="login" id="login">
            ...
            <form class="login-form" action="/api/en/v1/auth/reset-password" method="post">
                ...
                <input type="password" name="password_confirmation" class="login-input" placeholder="Confirm password" required autofocus />
                <div class="submit-container">
                    <button type="submit" class="login-button">{{__('auth.reset')}}</button>
                </div>
            </form>
        </section>
        <p>2021 - <a href="{{env('APP_URL')}}">{{env('APP_NAME')}}</a></p>
    </div>
